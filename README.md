...
## Guided Color Fix
Fixes color shift guided by a trained AI model that intelligently transfers colors from a reference while avoiding the bleed/bloom produced by the Average and Wavelet Color Fix when the shift is not uniform, but is much slower.
